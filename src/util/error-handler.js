...
const messages = {
  default: 'Could not connect to hydrusrv API. Please check your ' +
  ...
  shuttingDownError: 'hydrusrv is shutting down. This might be due to a ' +
    'reboot. Please check your server.',
  internalServerError: 'hydrusrv has encountered an internal error. Please ' +
    'check your server.'
}
